...
- Bachelor and Master in Statistics between the Universities of Bologna, Glasgow and Melbourne
...
I'm a Bioinformatics Data Scientist at [Mass Dynamics](https://www.massdynamics.com/)
...
- **Disclaimer**: My highlights also corresponds to talks presented in our timezone
...
- But! A great way to learn how to build an R 📦 is to create a data-package (package that only includes data)
- Free gift! Data packages are an enormously useful tool for teaching purposes (how many times have you used the `{iris}` 📦??!!) 

---

## 🐧 `{palmerpenguins}` : An alternative to `{iris}` 📦
...
**Philosophy** You don't need to move around functions and files to create a package, you oly need your Rmd with functions, documentation, tests, examples. 
...
- 🔗[OpeenIntro website](https://www.openintro.org/) has loads of resources to teach and learn statistics (for free!)
- 🔗[OpeenIntro R 📦](https://github.com/OpenIntroStat/openintro) has supplemental functions and data for OpenIntro resources.
...
.footnote[The Data Validation Cookbook: https://data-cleaning.github.io/validate/]
...
.center[<img class="circle" src="figures/rse-dos.png" width="650px" height = "500px"/>]
...
.center[<img class="circle" src="figures/toold-open-science.png" width="670px" height = "500px"/>]
...
# .center[[aRt gallery](https://user_2021.gitlab.io/user2021_art_gallery/#46)]

.footnote[*Yonder 1831*, 2021 by Thomas Lin Pedersen (Denmark). Flow lines, nearest neighbour, texture blending*]
...
- But, Mass Dynamics wants to make the functionalities of the R packages easily available also to 👩‍🔬  life scientist who cannot code  
...
You find them in the `DESCRIPTION` file of a package, diguising under:
...
How do you determine all the dependencies of an R package/project to make it reporodcible, open, shareable, safe for production?
